[![Run App Colman Scharff](https://github.com/Colman-Scharff/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Colman-Scharff/GithubActions/actions/workflows/run-app.yaml)
